...
class TestMoneyCreation:
    def test_creates_money_from_decimal(self) -> None:
        money = Money(amount=Decimal("100.50"), currency=Currency.EUR)
    ...
    def test_from_value_accepts_integer(self) -> None:
        money = Money.from_value(100, Currency.EUR)

        assert money.amount == Decimal("100")

    def test_from_value_accepts_decimal(self) -> None:
        money = Money(Decimal("100.50"), Currency.EUR)

        assert money.amount == Decimal("100.50")

    def test_reject_non_decimal_amount_in_constructor(self) -> None:
    ...
    @pytest.mark.parametrize(
        "value", ["not-a-number", "", "NaN", "Infinity", "-Infinity"]
    )
    def test_from_value_rejects_invalid_amounts(self, value) -> None:
        with pytest.raises(InvalidMoneyAmountError):
            Money.from_value(value, Currency.EUR)

    def test_rejects_invslid_currency_type(self) -> None:
...
class TestMoneyArthimetic:
    ...
    def test_subtracts_same_currency(self) -> None:
        first = Money.from_value("100.25", Currency.EUR)
    ...
    def test_rejects_addition_of_different_currencies(self) -> None:
    ...
    def test_rejects_subtracrion_of_different_currencies(self) -> None:
        eur = Money.from_value("100", Currency.EUR)
        usd = Money.from_value("100", Currency.USD)
    ...
    def test_multiplies_by_decimal(self) -> None:
        money = Money.from_value("100", Currency.EUR)
    ...
    def test_multiplies_by_integer(self) -> None:
    ...
    def test_divides_by_integer(self) -> None:
        money = Money.from_value("100", Currency.EUR)
    ...
    def test_divides_by_decimal(self) -> None:
        money = Money.from_value("100", Currency.EUR)
    ...
    def test_rejects_invalid_multiplication_factor(self, factor) -> None:
        money = Money.from_value("100", Currency.EUR)
    ...
    def test_rejects_invalid_divisor(self, divisor) -> None:
        money = Money.from_value("100", Currency.EUR)
...
class TestMoneyConversion:
    def test_converts_using_explicit_exchange_rate(self) -> None:
        money = Money.from_value("100", Currency.EUR)
    ...
    def test_conversion_does_not_mutate_original_money(self) -> None:
        money = Money.from_value("100", Currency.EUR)
    ...
    def test_same_currency_conversion_returns_same_value(self) -> None:
        money = Money.from_value("100", Currency.EUR)
    ...
    def test_rejects_invalid_exchange_rate(self, rate) -> None:
        money = Money.from_value("100", Currency.EUR)

        with pytest.raises(InvalidExchangeRateError):
            money.convert(Currency.USD, rate)
...
class TestMoneyState:
    ...
    def test_money_is_not_mutable(self) -> None:
